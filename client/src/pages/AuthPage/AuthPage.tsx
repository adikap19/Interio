  ...
  return (
    <div className="auth-root">
      ...
      <div className="auth-left">
        ...
        <div className="auth-left__bottom">© 2025 Interio. All rights reserved.</div>
      </div>
        ...
        <div className="auth-form-wrapper">
          <div className="auth-form-wrapper__header">
            ...
            <p className="auth-form-wrapper__subtitle">
              {mode === 'login'
                ? <><span>Don't have an account? </span><a onClick={switchMode}>Sign up</a></>
                : <><span>Already have an account? </span><a onClick={switchMode}>Sign in</a></>
              }
            </p>
          </div>
                ...
                InputProps={{
                  ...
                  endAdornment: (
                    <InputAdornment position="end">
                      <IconButton onClick={() => setShowPass(p => !p)} size="small" edge="end">
                        {showPass
